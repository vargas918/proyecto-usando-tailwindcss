...
const orderSchema = new mongoose.Schema({
    ...
    /*
 * ¿Por qué guardamos price y name en el pedido?
 * 
 * PROBLEMA: Si solo guardamos referencias al producto:
 * - El producto cambia de precio de $100 a $150
 * - Los pedidos antiguos mostrarían $150 (incorrecto)
 * - Perdemos el historial real de lo que pagó el cliente
 * 
 * SOLUCIÓN: Guardar datos al momento de la compra:
 * - products[].product: Referencia al producto (para populate)
 * - products[].price: Precio que pagó realmente el cliente
 * - products[].name: Nombre que tenía el producto cuando se compró
 * 
 * ASÍ mantenemos:
 * - Historial preciso de transacciones ✅
 * - Capacidad de obtener datos actualizados del producto ✅
